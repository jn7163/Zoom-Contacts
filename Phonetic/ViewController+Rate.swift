...
extension ViewController {
    ...
    func rateMeInTheSecondTime() {
        ...
        guard userDefaults.integerForKey(rateMe) != 2 else {
            ...
            // rate me
            let title = NSLocalizedString("Rate ♡ Me", comment: "alert controller title - rate me")
            let message = NSLocalizedString("If you enjoy using this App, would you mind taking a moment to rate it? It won't take more than one minute. Thanks a lot!", comment: "alert controller message")
