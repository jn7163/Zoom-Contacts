...
extension ViewController: UIPopoverPresentationControllerDelegate {
    ...
    private struct Popover {
        ...
        private static let preferredMutableContentHeight = min(500, UIScreen.screenHeight() * 0.8)
    ...
    private func popoverPresentViewController(button: PopoverButton) {
        ...
        case .Setting:
            guard let settingVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewControllerWithIdentifier(String(AdditionalSettingsViewController)) as? AdditionalSettingsViewController else { return }
