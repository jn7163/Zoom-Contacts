...
extension ViewController: UIPopoverPresentationControllerDelegate {
    ...
    private func popoverPresentViewController(button: PopoverButton) {
        ...
        case .Setting:
            guard let settingVC = UIStoryboard.Main.instantiateViewControllerWithIdentifier(String(AdditionalSettingsViewController)) as? AdditionalSettingsViewController else { return }
